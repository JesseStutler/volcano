...
import (
	...
	queucli "volcano.sh/volcano/pkg/cli/queue"
)
...
func GetPodGroupStatistics(ctx *TestContext, namespace, queue string) *queucli.PodGroupStatistics {
	...
	pgStats := &queucli.PodGroupStatistics{}
