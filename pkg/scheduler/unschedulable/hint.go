...
func gangMinimumsReachable(job *api.JobInfo, skipped map[api.TaskID]struct{}) bool {
...
func countPotentialGangMembers(index map[api.TaskStatus]api.TasksMap, skipped map[api.TaskID]struct{}) gangMemberCounts {
